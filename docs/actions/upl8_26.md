# UPL8_26 — Shepherding livestock on moorland (remove stock for at least 4 months)

Configured in `configurations/land-grants/actions/UPL8_26/`. 1 version(s) documented, newest first.
