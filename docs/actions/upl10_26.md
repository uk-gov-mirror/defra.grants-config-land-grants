# UPL10_26 — Shepherding livestock on moorland (remove stock for at least 8 months)

Configured in `configurations/land-grants/actions/UPL10_26/`. 1 version(s) documented, newest first.
